        ...
        <div class="col-md-12 col-xs-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6 col-xs-12 panel" ng-repeat='entry in entries'>
                      <!-- image, designer name and email -->

                      <div class="form-horizontal">
                          <div class="form-group">
                            <img src="@{{entry.main}}" ng-init="entry.main=entry.src_front" alt="image of entry" class="img img-thumbnail img-corner center-block col-md-12"  />
                          </div>

                          <div class="form-group">
                            <div class="parent-container popup-gallery">
                              <a  ng-mouseover='entry.main=entry.src_front' class="col-md-4 col-xs-4"><img src="@{{entry.src_front}}" class='img-responsive center-block' alt="" /></a>
                              <a  ng-mouseover='entry.main=entry.src_back' class="col-md-4 col-xs-4"><img src="@{{entry.src_back}}" class='img-responsive center-block' alt="" /></a>
                              <a  ng-mouseover='entry.main=entry.src_side' class="col-md-4 col-xs-4"><img src="@{{entry.src_side}}" class='img-responsive center-block' alt="" /></a>
                            </div>
                          </div>
                          <div class="form-group">
